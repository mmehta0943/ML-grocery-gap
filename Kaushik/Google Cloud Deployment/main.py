...
df_diabetes = pd.read_csv(r"C:\Users\kmoudgalya\Desktop\Hackathon Presentations\predict_proba.csv")
...
df_stores = pd.read_csv(r"C:\Users\kmoudgalya\Desktop\Hackathon Presentations\output_file2.csv", names=['Probability', 'FIPS'], header=0)
...
# Model images
rocauc_image = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\rocauc.png', 'rb').read())
rocauc_2 = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\ROC-AUC curve grocery.png', 'rb').read())
feature_import = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\Diabetes Model Feature Importance.png', 'rb').read())
# Home page images
deloitte = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\Deloitte_Logo.png', 'rb').read())
austin = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\AL.png', 'rb').read())
kaushik = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\KM.png', 'rb').read())
milonee = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\MM.png', 'rb').read())
swapna = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\SB.png', 'rb').read())
rohit = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\RS.png', 'rb').read())
# Project description images
fig301 = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\Outnumber Hunger.png', 'rb').read())
fig302 = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\Food Insecurity Spiral.png', 'rb').read())
fig303 = base64.b64encode(open(r'C:\Users\kmoudgalya\Desktop\Hackathon Presentations\Model Development.png', 'rb').read())
#
...
index_page = html.Div([
    ...
    html.Br(),
    dcc.Link('Go to the Combined Model Results', href = '/page-4'),
    html.Br(),
...
page_4_layout = html.Div([ 
    html.H1(children='Combined Results'),
    
    html.H2(children='Comparing the Model results:'),
    html.Div([
        dcc.Graph(
        id='my-graph-1',
        figure=fig
